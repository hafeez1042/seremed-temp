 ...
 * tags:
 *   name: Industries
 *   description: The industriesRouter managing API
 * /industriesRouter:
 *   get:
 *     summary: Lists all the industriesRouter
 *     tags: [Industries]
 *     responses:
 *       200:
 *         description: The list of the industriesRouter
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *     responses:
 *       200:
 *         description: The industry response by id
 *         contens:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Industry'
 ...
 *   put:
 *    summary: Update the industry by the id
 *    tags: [Industries]
 *    parameters:
 *      - in: path
 *        name: id
