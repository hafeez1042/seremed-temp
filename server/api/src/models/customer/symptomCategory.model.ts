...
interface ISymptomCategoryCreationAttributes extends Optional<ISymptomCategory, modelAttributesOptionalTypes> {}

export function initializeSymptomCategoryModel(sequelize: Sequelize) {
  class SymptomCategory extends Model<ISymptomCategory, ISymptomCategoryCreationAttributes> implements ISymptomCategory {
    public id!: string;
    public name!: string;
