...
interface IEquipmentCategoryCreationAttributes
  extends Optional<IEquipmentCategory, modelAttributesOptionalTypes> {}

export function initializeEquipmentCategoryModel(sequelize: Sequelize) {
  class EquipmentCategory
    extends Model<IEquipmentCategory, IEquipmentCategoryCreationAttributes>
    implements IEquipmentCategory
  {
    public id!: string;
    public name!: string;
  ...
  return EquipmentCategory as ModelType<
    IEquipmentCategory,
    IEquipmentCategoryCreationAttributes,
    EquipmentCategory
  >;
}

export function initializeEquipmentCategoryModelAssociation(
