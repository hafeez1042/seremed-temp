...
export function initializeSymptomQuestionnaireResponseModel(sequelize: Sequelize) {
  class SymptomQuestionnaireResponse extends Model<ISymptomQuestionnaireResponse> implements ISymptomQuestionnaireResponse {
    public id!: string;
  ...
  return SymptomQuestionnaireResponse;
}
